    ...
    <nav className="bg-background-300">
      <div className="flex justify-between items-center px-8 py-4 max-w-[1440px] mx-auto">
        <div className="flex items-center gap-2">
          ...
          <Link href='/research' className="text-accent-700 hover:text-primary-300 ml-12 mr-4 self-end z-[100]">
            Research
          </Link>
          <Link href='/products' className="text-accent-700 hover:text-primary-300 mx-4 self-end z-[100]">
            Shop
          </Link>
